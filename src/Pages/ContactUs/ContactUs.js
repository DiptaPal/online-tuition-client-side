                    ...
                    <div className="max-w-xl mx-auto">
                        <div className="text-center ">
                            <div className="relative flex flex-col items-center">
                                <div
                                    className="absolute hidden md:block -top-14 left-0 text-[120px] text-orange-400 font-bold opacity-10">
                                    Contact
                                </div>
                                <h1 className="text-5xl font-bold"> Our <span className="text-navActive"> Contact
                                </span> </h1>
                                <div className="flex w-24 mt-1 mb-10 overflow-hidden rounded">
                                    ...
                                    <div className="flex-1 h-2 bg-orange-600">
                                    </div>
                                </div>
                            </div>
                            <p className="mb-16 text-base text-center text-gray-500">
                                Free to ask anything about our services. We are always ready to help you.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                            <div
                                ...
                                <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                                    Email</h2>
                                <Link 
                                    className="text-base font-medium text-gray-500 md:text-lg">onlinestudy@gmail.com</Link>
                            </div>
                        </div>
                        <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                            <div
                                ...
                                <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                                    Phone</h2>
                                <Link 
                                    className="text-base font-medium text-gray-500 md:text-lg">+9876542312</Link>
                            </div>
                        </div>
                        <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                            <div
                        ...
                        <div>
                            ...
                            <input
                                ...
                                <textarea rows="4" type="message" placeholder="Write a message..." required=""
                                    className="block w-full px-4 mb-4 leading-tight text-gray-700 border rounded bg-gray-50"></textarea>
                                <button
                                    className="w-full py-4 text-sm border leading-normal font-medium tracking-wide bg-navActive text-white transition duration-200 rounded-md shadow-md hover:bg-white hover:text-navActive focus:shadow-outline focus:outline-none">
                                    Send Message
                                </button>
                        </div>
                    </div>
