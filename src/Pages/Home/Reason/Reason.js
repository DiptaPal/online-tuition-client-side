            ...
            <div className='col-span-12 mt-6 lg:mt-0 lg:col-span-7'>
                <div className='flex flex-col justify-center items-center'>
                    <div className='flex flex-col gap-4 sm:gap-0 sm:flex-row justify-around sm:w-[530px] mx-auto'>
                        ...
                        <div data-aos="fade-down-left" className='h-60 w-60 text-left p-4 rounded-md shadow shadow-navActive'>
                    ...
                    <div className='flex flex-col gap-4 sm:gap-0 sm:flex-row justify-around mt-4 sm:mt-6 sm:w-[530px] mx-auto'>
                        <div data-aos="fade-up-right" className='h-60 w-60 text-left p-4 rounded-md shadow shadow-navActive'>
                        ...
                        <div data-aos="fade-up-left" className='h-60 w-60 text-left p-4 rounded-md shadow shadow-navActive'>
