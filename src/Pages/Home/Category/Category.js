...
const Category = ({ category }) => {
    ...
    return (
        <div  data-aos="flip-left" className="max-w-xs rounded-md border border-white hover:border-navActive transition-colors  shadow-md cursor-pointer duration-500 bg-white text-gray-800 mx-auto">
