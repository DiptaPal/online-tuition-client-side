        ...
        <div>
            <section className="py-6 my-20">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div data-aos="fade-right" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white shadow-md focus:shadow-outline">
                    ...
                    <div data-aos="fade-up" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white shadow-md focus:shadow-outline">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-navActive">
                    ...
                    <div data-aos="fade-down" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white shadow-md focus:shadow-outline">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-navActive">
                    ...
                    <div data-aos="fade-left" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white shadow-md focus:shadow-outline">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-navActive">
